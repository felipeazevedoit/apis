    ...
    public class DocumentoCross : ICross<Documento>
    {
        ...
        public async Task<Documento> SaveAsync(Documento entity, string token)
        {
            try
            {
                ...
                {
                    case 0:
                        entity.DataCriacao = DateTime.ParseExact(DateTime.Now.ToString("yyyy-MM-dd"), "yyyy-MM-dd", CultureInfo.InvariantCulture);
                        entity.DataEdicao = DateTime.ParseExact(DateTime.Now.ToString("yyyy-MM-dd"), "yyyy-MM-dd", CultureInfo.InvariantCulture);
