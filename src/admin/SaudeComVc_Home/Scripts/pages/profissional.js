...
function cadProfissional() {
    ...
    if ($("#senha").val() == $("#confirmarSenha").val()) {
        ...
        var urlU = "http://187.84.232.164:5300/api/Seguranca/Principal/salvarUsuario/12/999";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var urlP = "http://187.84.232.164:5300/api/Seguranca/wpProfissionais/SalvarProfissional/12/999";
...
function perfil(data,obj) {
    ...
    var urlPerfil = "http://187.84.232.164:5300/api/Perfil/SaveUsuarioXPerfil";
...
//    var url = "http://187.84.232.164:5300/api/Seguranca/wpProfissionais/BuscarServico/12/999";
...
function vincular(obj, data) {
    ...
    var urlP = "http://187.84.232.164:5300/api/Seguranca/wpProfissionais/VincluarProfissionalServico/12/999";
