...
function medico(data)
{
    ...
    var urlM = "http://187.84.232.164:5300/api/Seguranca/WpMedicos/SalvarMedico/12/999";
...
function pagina(obj, data) {
    ...
    var urlMP = "http://187.84.232.164:5300/api/Seguranca/Paginas/SalvarPagina/12/" + data.id + "";
...
//    var url = "http://187.84.232.164:5300/api/Seguranca/WpMedicos/BuscarEspecialidades/12/999";
