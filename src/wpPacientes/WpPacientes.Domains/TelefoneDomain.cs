    ...
    public class TelefoneDomain : IDomain<Telefone>
    {
        ...
        public async Task DeleteAsync(int pacienteId, string token)
        {
            try
            {
                ...
                var telefone = _repository.GetList(t => t.PacienteId.Equals(pacienteId)).SingleOrDefault();
        ...
        public IEnumerable<Telefone> GetAlls(IEnumerable<int> pacienteIds, string token)
        {
            try
            {
                //await _segService.ValidateTokenAsync(token);
                var telefones = _repository.GetList(t => pacienteIds.Contains(t.PacienteId));
        ...
        public async Task<Telefone> GetByPacienteIdAsync(int pacienteId, int idCliente, string token)
        {
            try
            {
                await _segService.ValidateTokenAsync(token);

                var telefone = _repository.GetList(t => t.PacienteId.Equals(pacienteId)
